...
object AndroidVersion {
    ...
    const val APPLICATION_ID = "com.ahmetbabacan.movies"
}
...
object Version {
    ...
    //Bindables - DataBinding
    const val BINDABLES_VERSION = "1.0.4"

    //Image Loading
    const val COIL_VERSION = "1.1.1"

    //Viewpager Indicator
    const val VIEWPAGER_INDICATOR_VERSION = "1.2.1"
...
object TestVersion {
    ...
    // Mockito Inline
    const val turbineVersion = "0.4.0"
}